...
export function createDocument12( { exceljs, fileSaver, instituteName, structuringCore, logoImage, career, company, electivePeriod, academicPeriod, firstName, secondName, lastName, secondLastName, businessTutor, academicTutor }: DocumentProps ) {
  ...
  workSheet1.getCell( 'B21' ).value = 'Construir interfaces gráficas utilizando HTML5 y CSS3 para integrar en aplicaciones web.';
  workSheet1.getCell( 'B21' ).alignment = { vertical: 'middle', horizontal: 'left', wrapText: true };

  workSheet1.getCell( 'B22' ).value = 'Programar con lenguaje javascript y typescript para manejar el modelo en cliente.';
  workSheet1.getCell( 'B22' ).alignment = { vertical: 'middle', horizontal: 'left', wrapText: true };

  workSheet1.getCell( 'B23' ).value = 'Utilizar angular en una página HTML para mapear la vista y el modelo.';
  workSheet1.getCell( 'B23' ).alignment = { vertical: 'middle', horizontal: 'left', wrapText: true };

  workSheet1.getCell( 'B24' ).value = 'Comprender los patrones MVC y MVVM para estructurar adecuadamente los componentes de una aplicación web.';
  ...
  workSheet1.getCell( 'B26' ).value = 'Construir  servicios REST y servicios con estado, para permitir el consumo de datos desde un cliente.';
  workSheet1.getCell( 'B26' ).alignment = { vertical: 'middle', horizontal: 'left', wrapText: true };

  workSheet1.getCell( 'B27' ).value = 'Crear bases de datos estructuradas con la ayuda de un lenguaje estandarizado.';
  workSheet1.getCell( 'B27' ).alignment = { vertical: 'middle', horizontal: 'left', wrapText: true };

  workSheet1.getCell( 'B28' ).value = 'Implementar aplicaciones Single Page Applications (SPA) que se carguen por componentes para una navegación óptima.';
  workSheet1.getCell( 'B28' ).alignment = { vertical: 'middle', horizontal: 'left', wrapText: true };

  workSheet1.getCell( 'B29' ).value = 'Aplicar un entorno de programación (plataforma) para la programación.';
  workSheet1.getCell( 'B29' ).alignment = { vertical: 'middle', horizontal: 'left', wrapText: true };

  workSheet1.getCell( 'B30' ).value = 'Emplear procedimientos de comunicación e interacción con el usuario para un correcto uso de la aplicación.';
  ...
  workSheet1.getCell( 'B32' ).value = 'Programar con lenguaje estandarizado, orientado a objetos, para la definición, manipulación y gestión de datos.';
  workSheet1.getCell( 'B32' ).alignment = { vertical: 'middle', horizontal: 'left', wrapText: true };

  workSheet1.getCell( 'B33' ).value = 'Aplicar un entorno de programación (plataforma) para la programación.';
  ...
  workBook.xlsx.writeBuffer()
    .then( ( buffer ) => {
      ...
      fileSaver.saveAs(blob, 'CUARTO-Plan Marco Formación y Rotación.xlsx');
    } )
    .catch( ( error ) => {
