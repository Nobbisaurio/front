...
export function createDocument8( { fileSaver, exceljs, instituteName, logoImage, company, dni, firstName, secondName, lastName, secondLastName, academicTutor, businessTutor, email, career, academicPeriod, electivePeriod }: DocumentProps ) {
  ...
  workSheet.getCell( 'D3' ).value = 'PROCESO 02 PROCESO DE FORMACIÓN PRÁCTICA EN EL ENTORNO LABORAL REAL  - FORMACIÓN DUAL';
  workSheet.getCell( 'D3' ).fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'e6802c' } };
  workSheet.getRow( 3 ).height = 40;

  workSheet.mergeCells( 'D4:J4' );
  workSheet.getCell( 'D4' ).value = 'FORMATO 06 BITÁCORA DE APRENDIZAJE DE FASE PRÁCTICA';


  workSheet.getColumn( 'K' ).width = 15;
  workSheet.getColumn( 'L' ).width = 15;
  workSheet.getCell( 'K1' ).value = 'VERSIÓN';
  workSheet.getCell( 'L1' ).value = '1.0';

  workSheet.getCell( 'K2' ).value = 'ELABORACIÓN';
  workSheet.getCell( 'L2' ).value = '06-06-2023';

  workSheet.getCell( 'K3' ).value = 'ACTUALIZACIÓN';
  workSheet.getCell( 'L3' ).value = '06-06-2023';

  workSheet.getCell( 'K4' ).value = 'CÓDIGO';
  workSheet.getCell( 'L4' ).value = 'DS-010206';
