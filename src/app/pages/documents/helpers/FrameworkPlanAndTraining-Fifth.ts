...
export function createDocument13( { exceljs, fileSaver, instituteName, logoImage, career, company, electivePeriod, academicPeriod, firstName, secondName, lastName, secondLastName, businessTutor, academicTutor }: DocumentProps ) {
  ...
  workSheet1.getCell( 'B21' ).value = 'Comprende los conceptos, niveles y áreas del CMMI';
  workSheet1.getCell( 'B21' ).alignment = { vertical: 'middle', horizontal: 'left', wrapText: true };

  workSheet1.getCell( 'B22' ).value = 'Estructura de forma adecuada la línea de investigación entre los objetivos y el desarrollo de su investigación, para el desarrollo del trabajo de grago enfocado a resolver problemas reales.';
  workSheet1.getCell( 'B22' ).alignment = { vertical: 'middle', horizontal: 'left', wrapText: true };

  workSheet1.getCell( 'B23' ).value = 'Comprende los conceptos de la cultura de calidad y su aplicación al desarrollo de software y sistemas de información.';
  workSheet1.getCell( 'B23' ).alignment = { vertical: 'middle', horizontal: 'left', wrapText: true };

  workSheet1.getCell( 'B24' ).value = 'Incentiva la formación de las actitudes y habilidades que requieren para ser un emprendedor';
  workSheet1.getCell( 'B24' ).alignment = { vertical: 'middle', horizontal: 'left', wrapText: true };

  workSheet1.getCell( 'B25' ).value = 'identifica y potencializa las conductas de comportamiento que los emprendedores requieren para llevar con éxito cualquier proyecto personal y profesional';
  workSheet1.getCell( 'B25' ).alignment = { vertical: 'middle', horizontal: 'left', wrapText: true };

  workSheet1.getCell( 'B26' ).value = 'Desempeña correctamente su rol en proyectos informáticos, en contextos multidisciplinarios y multiculturales, tanto locales como globalizados';
  workSheet1.getCell( 'B26' ).alignment = { vertical: 'middle', horizontal: 'left', wrapText: true };

  workSheet1.getCell( 'B27' ).value = 'Aplica conceptos y definiciones de los fundamentos de redes para comunicar dispositivos.';
  workSheet1.getCell( 'B27' ).alignment = { vertical: 'middle', horizontal: 'left', wrapText: true };

  workSheet1.getCell( 'B28' ).value = ' Comprende los conceptos, niveles y áreas del CMMI';
  workSheet1.getCell( 'B28' ).alignment = { vertical: 'middle', horizontal: 'left', wrapText: true };

  workSheet1.getCell( 'B29' ).value = ' Comprende los elementos principales del sistema de calidad basado en la norma ISO 9000:2000';
  workSheet1.getCell( 'B29' ).alignment = { vertical: 'middle', horizontal: 'left', wrapText: true };

  workSheet1.getCell( 'B30' ).value = 'Comprende el ámbito del proceso y técnicas de pruebas de software. ';
  workSheet1.getCell( 'B30' ).alignment = { vertical: 'middle', horizontal: 'left', wrapText: true };

  workSheet1.getCell( 'B31' ).value = 'Demuestra cualidades de espíritu emprendedor y liderazgo para la gestión de proyectos empresariales y sociales, en los sectores públicos y privados.';
  workSheet1.getCell( 'B31' ).alignment = { vertical: 'middle', horizontal: 'left', wrapText: true };

  workSheet1.getCell( 'B32' ).value = 'Plantea un modelo de negocio innovador';
  workSheet1.getCell( 'B32' ).alignment = { vertical: 'middle', horizontal: 'left', wrapText: true };

  workSheet1.getCell( 'B33' ).value = 'Comprende las principales características de los procesos del ciclo de vida del estándar ISO/IEC 15504.';
