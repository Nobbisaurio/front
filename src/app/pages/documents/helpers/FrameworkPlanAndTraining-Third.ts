...
export function createDocument11({
  exceljs,
  fileSaver,
  instituteName,
  structuringCore,
  ...
  workSheet1.getCell('C4').value =
    'FORMATO 06 BITÁCORA DE APRENDIZAJE DE FASE PRÁCTICA';
  ...
  workSheet1.getCell('A10').alignment = {
    vertical: 'middle',
    horizontal: 'center',
    wrapText: true,
  };
  ...
  workSheet1.getCell('A13').value =
    '3: PARTICIPACION EN LOS PROCEDIMIENTOS: El estudiante de la carrera dual debe adquirir las suficientes capacidades prácticas de tal forma que pueda realizar las tareas o pueda preparar su ejecución.';
  workSheet1.getRow(14).height = 35;
  workSheet1.getCell('A14').value =
    '4: VALORACIÓN O ELABORACIÓN PROPIA DE PROCEDIMIENTOS DE TRABAJO: El estudiante de la carrera dual, se debe formar en la aplicación práctica, de tal forma que pueda realizar o elaborar las tareas sin indicaciones y además pueda evaluar una tarea de acuerdo a su criterio.';
  ...
  workSheet1.getCell('A16').value =
    'OBJETIVOS DE LA FASE PRÁCTICA: Aplicar de forma autónoma la lógica de programación para el desarrollo de algoritmos sencillos  utilizando una sintaxis adecuada.';
  workSheet1.getCell('A16').fill = {
    type: 'pattern',
    pattern: 'solid',
    fgColor: { argb: 'bfbfbf' },
  };
  ...
  workSheet1.getCell('A17').value =
    'OBJETIVOS DE APRENDIZAJE: Al finalizar la fase práctica, el/la estudiante estará en capacidad de:';
  ...
  workSheet1.getCell('B21').value =
    'Crear páginas web dinámicas utilizando la arquitectura cliente - servidor.';
  workSheet1.getCell('B21').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet1.getCell('B22').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };

  workSheet1.getCell('B23').value =
    'Aplicar modelos matemáticos para la resolución de problemas informáticos, técnicos, de las ciencias básicas y administrativas.';
  workSheet1.getCell('B23').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };

  workSheet1.getCell('B24').value =
    'Utilizar frameworks de diseño y hojas de estilo en cascada aplicadas a páginas web estáticas.';
  workSheet1.getCell('B24').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };

  workSheet1.getCell('B25').value =
    'Elaborar documentos de soporte para usuarios.';
  workSheet1.getCell('B25').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };

  workSheet1.getCell('B26').value =
    'Identificar procesos continuos y discontinuos.';
  workSheet1.getCell('B26').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };

  workSheet1.getCell('B27').value =
    'Diagramar modelos entidad-relación de situaciones empresariales reales.';
  workSheet1.getCell('B27').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };

  workSheet1.getCell('B28').value =
    'Analizar procesos discretos con ayuda de sucesiones y series matemáticas.';
  workSheet1.getCell('B28').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };

  workSheet1.getCell('B29').value =
    'Realizar la modelación de objetos, con un lenguaje de marcado estandarizado.';
  workSheet1.getCell('B29').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };

  workSheet1.getCell('B30').value =
    'Desarrollar una estrategia para solucionar problemas con la ayuda de métodos estandarizados.';
  workSheet1.getCell('B30').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };

  workSheet1.getCell('B31').value =
    'Crear bases de datos estructuradas con la ayuda de un lenguaje estandarizado.';
  workSheet1.getCell('B31').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };

  workSheet1.getCell('B32').value =
    'Distinguir y clasificar lenguajes de programación.';
  workSheet1.getCell('B32').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };

  workSheet1.getCell('B33').value =
    'Analizar la complejidad de algoritmos al respecto de tiempo de ejecución, espacio de memoria y propensión a errores, y dictamen del esfuerzo de la programación.';
  workSheet1.getCell('B33').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };

  workSheet1.getCell('B34').value =
    'Realizar diagramas de clases con un método estandarizado.';
  workSheet1.getCell('B34').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };

  workSheet1.getCell('B35').value =
    'Programar con lenguaje estandarizado, orientado a objetos, para la definición, manipulación y gestión de datos.';
  workSheet1.getCell('B35').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet1.getCell('B36').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet1.getCell('B37').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };

  workSheet1.getCell('B38').value =
    'Gestionar la información almacenada en una base de datos usando lenguaje estandarizado de consultas.';
  workSheet1.getCell('B38').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };

  workSheet1.getCell('B39').value =
    'Aplicar un entorno de programación (plataforma) para la programación.';
  workSheet1.getCell('B39').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };

  workSheet1.getCell('B40').value =
    'Considerar los derechos y obligaciones de la relación de formación entre empresa formadora y estudiante.';
  workSheet1.getCell('B40').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };

  workSheet1.getCell('B41').value =
    'Considerar los reglamentos legales y reglamentos internos de la empresa formadora.';
  workSheet1.getCell('B41').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };

  workSheet1.getCell('B42').value =
    'Abstraer situaciones empresariales diarias y hasta convertirlas en figuras, diagramas o relaciones.';
  workSheet1.getCell('B42').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };

  workSheet1.getCell('B43').value =
    'Elegir algoritmos en la realización de pliegos de condiciones, en particular los conceptos básicos como secuencias, selección e iteración.';
  workSheet1.getCell('B43').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };

  workSheet1.getCell('B44').value =
    'Describir tareas, organización y estructuras de decisiones en la empresa.';
  workSheet1.getCell('B44').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };

  workSheet1.getCell('B45').value =
    'Describir la forma legal de la empresa formadora.';
  workSheet1.getCell('B45').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };

  workSheet1.getCell('B46').value =
    'Describir la relación de la empresa formadora con las organizaciones del sector productivo, gremios e instituciones públicas.';
  workSheet1.getCell('B46').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };

  workSheet1.getCell('B47').value =
    'Explicar el objetivo y los campos de actividad de la empresa formadora y su posición en el mercado.';
  workSheet1.getCell('B47').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };

  workSheet1.getCell('B48').value =
    'Conocer las claúsulas fundamentales del contrato de formación dual entre la empresa formadora y la IES.';
  workSheet1.getCell('B48').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };

  workSheet1.getCell('B49').value =
    'Desarrollar la disposición del aprendizaje continuo e investigar las posibilidades de capacitación y formación continua.';
  workSheet1.getCell('B49').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };

  workSheet1.getCell('B50').value =
    'Analizar riesgos de trabajo en la empresa, para prevenir accidentes.';
  workSheet1.getCell('B50').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };

  workSheet1.getCell('B51').value =
    'Aplicar plan de contingencia en caso de un desastre (incendio, accidente, fenómenos naturales, etc.).';
  workSheet1.getCell('B51').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };

  workSheet1.getCell('B52').value =
    'Contribuir a la preservación del medio ambiente y reducir riesgos del trabajo del estudiante y la empresa.';
  workSheet1.getCell('B52').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };

  workSheet1.getCell('B53').value =
    'Proponer medidas para la optimización de procesos en el desarrollo y organización de la empresa.';
  workSheet1.getCell('B53').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet1.getCell('H19').value =
    '(ponga una X en el número correspondiente)';
  workSheet1.getCell('H19').fill = {
    type: 'pattern',
    pattern: 'solid',
    fgColor: { argb: 'bfbfbf' },
  };
  ...
  for (let row = 21; row <= 53; row++) {
    workSheet1.getCell(`L${row}`).value = {
      formula: `COUNTA(H${row}:K${row})`,
    };
  }

  workSheet1.mergeCells('M18:O20');
  workSheet1.getCell('M18').fill = {
    type: 'pattern',
    pattern: 'solid',
    fgColor: { argb: 'bfbfbf' },
  };
  workSheet1.getCell('M18').value =
    'Tareas laborales de aprendizaje a realizar para alcanzar el objetivo';
  ...
  workSheet1.getCell('P18').fill = {
    type: 'pattern',
    pattern: 'solid',
    fgColor: { argb: 'bfbfbf' },
  };
  workSheet1.getCell('P18').value =
    'Puesto de aprendizaje (área o departamento de la empresa)';
  ...
  workSheet2.getCell('B13').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet2.getCell('B15').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet2.getCell('B16').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet2.getCell('B17').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet2.getCell('B18').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet2.getCell('B19').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet2.getCell('B20').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet2.getCell('B21').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet2.getCell('B23').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet2.getCell('B24').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet2.getCell('B25').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet2.getCell('B26').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet2.getCell('B27').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet2.getCell('B28').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet2.getCell('B29').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet2.getCell('B30').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet2.getCell('B31').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet2.getCell('B32').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet2.getCell('B33').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet2.getCell('B34').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet2.getCell('B35').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet2.getCell('B36').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet2.getCell('B37').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet2.getCell('B38').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet2.getCell('B39').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet2.getCell('B40').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet2.getCell('B41').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet2.getCell('B42').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet2.getCell('B43').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet2.getCell('B44').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet2.getCell('B45').alignment = {
    vertical: 'middle',
    horizontal: 'left',
    wrapText: true,
  };
  ...
  workSheet2.getCell('I11').fill = {
    type: 'pattern',
    pattern: 'solid',
    fgColor: { argb: 'bfbfbf' },
  };
  workSheet2.getCell('I11').value =
    'Puesto de aprendizaje (área o departamento de la empresa)';
  ...
  workSheet2.getCell('A46').alignment = {
    vertical: 'middle',
    horizontal: 'center',
    wrapText: true,
  };
  ...
  workSheet2.getCell('L48').value =
    'Levanta requerimientos y diseña diagrmas en UML';
  ...
  workBook.xlsx
    ...
    .then((buffer) => {
      ...
      fileSaver.saveAs(blob, 'TERCERO-Plan Marco Formación y Rotación.xlsx');
    })
    .catch((error) => {
