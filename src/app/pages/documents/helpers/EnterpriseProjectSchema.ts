...
export function createDocument4( { docx, fileSaver, logoImage, instituteName, studentCareerName, studentEnterpriseName }: DocumentProps ) {
    ...
    sections: [ {
                      ...
                      children: [ new docx.Paragraph( {
                        children: [ new docx.TextRun( {
                          children: [
                            ...
                            new docx.TextRun( { text: "1.0", bold: true } )
                          ],
                        } ) ], alignment: 'center'
                      } ) ]
                    } ),
                    ...
                    new docx.TableCell( {
                      children: [ new docx.Paragraph( {
                        children: [
                          ...
                          new docx.TextRun( { text: "\n", break: 1 } ),
                          new docx.TextRun( { text: "06-06-2023", bold: true }, )
                        ], alignment: 'center'
                      } ) ]
                    } ),
                  ]
                  ...
                  children: [
                    new docx.TableCell( {
                      children: [
                        new docx.Paragraph( {
                          children: [
                            new docx.TextRun( { text: 'PROCESO 02 PROCESO DE FORMACIÓN PRÁCTICA EN EL ENTORNO LABORAL REAL - FORMACIÓN DUAL', bold: true } )
                          ], alignment: 'center'
                        } )
                      ],
                      shading: {
                  ...
                  children: [
                    new docx.TableCell( {
                      ...
                      children: [
                        new docx.Paragraph( {
                          children: [
                            new docx.TextRun( { text: 'FORMATO 09 PROYECTO EMPRESARIAL', bold: true } )
                          ], alignment: 'center'
                        } )
                      ]
                    } ),
                    new docx.TableCell( {
                      ...
                      children: [ new docx.Paragraph( {
                        children: [
                          ...
                          new docx.TextRun( { text: "\n", break: 1 } ),
                          new docx.TextRun( { text: "DS-102938", bold: true }, )
      ...
      children: [
        new docx.Paragraph( {
          ...
          children: [
            new docx.TextRun( { text: `CARRERA DE TECNÓLOGO SUPERIOR EN ${ studentCareerName }`, bold: true, break: 2, size: 28 } ),
            new docx.TextRun( { text: `${ studentEnterpriseName }`, bold: true, break: 4, size: 24 } ),
            ...
            new docx.TextRun( { text: 'Nombre del Proyecto', bold: true, break: 3, size: 24, highlight: 'yellow' } ),
          ], alignment: 'center'
        } ),
        new docx.Paragraph( {
          children: [
        ...
        new docx.Paragraph( {
          children: [
            new docx.TextRun( { text: `TUTOR ACADÉMICO: ${ 'NOMBRE APELLIDO' }`, bold: true, break: 3, size: 24 } ),
            new docx.TextRun( { text: `TUTOR EMPRESARIAL: ${ 'NOMBRE APELLIDO' }`, bold: true, break: 2, size: 24 } ),
          ], alignment: 'left'
        } ),
        new docx.Paragraph( {
          children: [
