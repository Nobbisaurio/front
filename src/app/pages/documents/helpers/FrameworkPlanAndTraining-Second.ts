...
export function createDocument10( { exceljs, fileSaver, instituteName, structuringCore, logoImage, career, company, electivePeriod, academicPeriod, firstName, secondName, lastName, secondLastName, businessTutor, academicTutor }: DocumentProps ) {
  ...
  for ( let row = 21; row <= 33; row++ ) {
    workSheet1.mergeCells( `B${ row }:G${ row }` );
  }

  workSheet1.getCell( 'B21' ).value = 'Abstraer situaciones empresariales diarias y hasta convertirlas en figuras, diagramas o relaciones.';
  workSheet1.getCell( 'B21' ).alignment = { vertical: 'middle', horizontal: 'left', wrapText: true };

  workSheet1.getCell( 'B22' ).value = 'Diagramar modelos entidad-relación de situaciones empresariales reales.';
  workSheet1.getCell( 'B22' ).alignment = { vertical: 'middle', horizontal: 'left', wrapText: true };

  workSheet1.getCell( 'B23' ).value = 'Crear bases de datos estructuradas con la ayuda de un lenguaje estandarizado.';
  workSheet1.getCell( 'B23' ).alignment = { vertical: 'middle', horizontal: 'left', wrapText: true };

  workSheet1.getCell( 'B24' ).value = 'Programar con lenguaje estandarizado para la definición, manipulación y gestión de datos.';
  workSheet1.getCell( 'B24' ).alignment = { vertical: 'middle', horizontal: 'left', wrapText: true };

  workSheet1.getCell( 'B25' ).value = 'Describir tareas, organización y estructuras de decisiones en la empresa.';
  workSheet1.getCell( 'B25' ).alignment = { vertical: 'middle', horizontal: 'left', wrapText: true };

  workSheet1.getCell( 'B26' ).value = 'Considerar los reglamentos legales y reglamentos internos de la empresa formadora.';
  workSheet1.getCell( 'B26' ).alignment = { vertical: 'middle', horizontal: 'left', wrapText: true };

  workSheet1.getCell( 'B27' ).value = 'Usar los medios y herramientas de trabajo y organización de una forma eficiente.';
  workSheet1.getCell( 'B27' ).alignment = { vertical: 'middle', horizontal: 'left', wrapText: true };

  workSheet1.getCell( 'B28' ).value = 'Gestionar la información almacenada en una base de datos usando lenguaje estarizado de consultas.';
  workSheet1.getCell( 'B28' ).alignment = { vertical: 'middle', horizontal: 'left', wrapText: true };

  workSheet1.getCell( 'B29' ).value = 'Explicar el objetivo y los campos de actividad de la empresa formadora y su posición en el mercado.';
  workSheet1.getCell( 'B29' ).alignment = { vertical: 'middle', horizontal: 'left', wrapText: true };

  workSheet1.getCell( 'B30' ).value = 'Realizar un análisis de las tareas y decidir la forma de organizar el trabajo.';
  workSheet1.getCell( 'B30' ).alignment = { vertical: 'middle', horizontal: 'left', wrapText: true };

  workSheet1.getCell( 'B31' ).value = 'Planificar tareas y trabajarlos en equipo, coordinar los resultados y analizarlos.';
  workSheet1.getCell( 'B31' ).alignment = { vertical: 'middle', horizontal: 'left', wrapText: true };

  workSheet1.getCell( 'B32' ).value = 'Usar los medios y herramientas de trabajo y organización de una forma eficiente.';
  workSheet1.getCell( 'B32' ).alignment = { vertical: 'middle', horizontal: 'left', wrapText: true };

  workSheet1.getCell( 'B33' ).value = 'Constatar peligros para seguridad y salud en el lugar de trabajo y tomar medidas para evitarlos.';
  ...
  workSheet1.mergeCells( 'P25:Q29' );
  workSheet1.getCell( 'P25' ).value = 'Ejm.:TICS';

  workSheet1.mergeCells( 'P30:Q33' );
  workSheet1.getCell( 'P30' ).value = 'Ejm.:TICS';
  ...
  workSheet1.mergeCells( 'R25:R29' );
  workSheet1.getCell( 'R25' ).value = 1;

  workSheet1.mergeCells( 'R30:R33' );
  workSheet1.getCell( 'R30' ).value = 1;
  ...
  workSheet1.mergeCells( 'S25:S29' );
  workSheet1.getCell( 'S25' ).value = 'Ejm.:  René Rivas Jefe de Operaciones';

  workSheet1.mergeCells( 'S30:S33' );
  workSheet1.getCell( 'S30' ).value = 'Ejm.:  René Rivas Jefe de Operaciones';


  workSheet1.mergeCells( 'A34:S34' );
  workSheet1.getCell( 'A34' ).value = 'NOTA: Puede agregar más objetivos de ser necesario o redactar de acuerdo a las necesidades particulares de cada Empresa Formadora. También puede eliminar los objetivos que no apliquen para la fase práctica.';
  workSheet1.getCell( 'A34' ).font = { size: 9, bold: true };


  workSheet1.mergeCells( 'B36:F36' );
  ...
  workSheet2.mergeCells( 'I17:K21' );
  workSheet2.getCell( 'I17' ).value = 'Ejm.: Tics';
  workSheet2.mergeCells( 'I22:K25' );
  workSheet2.getCell( 'I22' ).value = 'Ejm.: Tics';
  ...
  workSheet2.mergeCells( 'A26:S26' );
  workSheet2.getCell( 'A26' ).value = 'COMPETENCIAS NECESARIAS';
  workSheet2.getCell( 'A26' ).font = { bold: true };
  workSheet2.getCell( 'A26' ).alignment = { vertical: 'middle', horizontal: 'center', wrapText: true };
  ...
  workSheet2.mergeCells( 'A27:K27' );
  workSheet2.getCell( 'A27' ).font = { bold: true };
  workSheet2.getCell( 'A27' ).value = 'CONOCIMIENTOS TEÓRICOS';


  workSheet2.mergeCells( 'A28:K30' );
  workSheet2.getCell( 'A28' ).value = 'Análisis y diseño de sistemas';

  workSheet2.mergeCells( 'L27:P27' );
  workSheet2.getCell( 'L27' ).font = { bold: true };
  workSheet2.getCell( 'L27' ).value = 'PROCEDIMENTALES';

  workSheet2.mergeCells( 'L28:P30' );
  workSheet2.getCell( 'L28' ).value = 'Levanta requerimientos y diseña diagrmas en UML';

  workSheet2.mergeCells( 'Q27:S27' );
  workSheet2.getCell( 'Q27' ).font = { bold: true };
  workSheet2.getCell( 'Q27' ).value = 'ACTITUDINALES';

  workSheet2.mergeCells( 'Q28:S30' );
  workSheet2.getCell( 'Q28' ).value = 'Proactividad, creatividad, analítico';


  workSheet2.mergeCells( 'B32:F32' );
  ...
  workBook.xlsx.writeBuffer()
    .then( ( buffer ) => {
      ...
      fileSaver.saveAs(blob, 'SEGUNDO-Plan Marco Formación y Rotación.xlsx');
    } )
    .catch( ( error ) => {
