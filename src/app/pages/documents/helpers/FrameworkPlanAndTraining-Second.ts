...
export function createDocument10( { exceljs, fileSaver, instituteName, logoImage, career, company, electivePeriod, academicPeriod, firstName, secondName, lastName, secondLastName, businessTutor, academicTutor }: DocumentProps ) {
